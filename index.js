...
f = '_' //biarin aja
blocked = [] // biarin aja
fake = '- sᴇʟғʙᴏᴛ ʙʏ ᴇᴋᴀ ɢᴀɴs -' //ganti nama bot lu
fakeimage = fs.readFileSync(`./media/Danu.jpeg`)
numbernye = '0'
join = '\`\`\`New Member\`\`\` \n \`\`\`Nama :\`\`\` \n \`\`\`Askot : \`\`\` \n \`\`\`Umur :\`\`\` \n \`\`\`Status :\`\`\` \n\n - [ 𝙀𝙆𝘼 𝘽𝙊𝙏 ] -'  //ganti terserah lu
leave = '\`\`\`Sayonaraa👋\`\`\`'  //ganti terserah lu
promote = '*Your Welcome🥳*'  //ganti terserah lu
demote = '*Yahahahwahyuuu kasihaan di demote🤣*'  //ganti terserah lu
public = false
...
const ftroli = {
 key: {
  ...
  message: { 
   ...
   surface: 200,
   message: 'sᴇʟғʙᴏᴛ ʙʏ ᴇᴋᴀ ɢᴀɴs',  //ganti nama bot lu
...
├ 「 *ᴍᴇɴᴜɴʏᴀ* 」
│
├ ${f}${prefix}sᴛɪᴄᴋᴇʀ Reply img${f}
├ ${f}${prefix}sᴛɪᴄᴋᴇʀɢɪғ Reply video${f}
├ ${f}${prefix}sᴛɪᴄᴋᴇʀᴡᴍ Nama|Author${f}
├ ${f}${prefix}ᴛᴀᴋᴇ Nama|Author${f}
├ ${f}${prefix}ᴇxɪғ Nama|Author${f}
├ ${f}${prefix}ᴄᴏʟᴏɴɢ${f}
├ ${f}${prefix} ᴅᴏɴᴀsɪ${f}
├ ${f}${prefix}ᴛʀᴏʟʟɪ${f}
├ ${f}${prefix}ғᴅᴇғᴀᴄᴇ Url|title|desk${f}                //Kasih nama gua lah  "EKA DANU ARTA" / EKA GANS
├ ${f}${prefix}ᴛᴏɢɪғ Reply stickergif${f}
├ ${f}${prefix}ᴛᴏɪᴍɢ Reply sticker${f}
├ ${f}${prefix}sʟᴏᴛ${f}
├ ${f}${prefix}sᴇʟғ${f}
├ ${f}${prefix}ᴘᴜʙʟɪᴄ${f}
├ ${f}${prefix}ᴍᴜᴛᴇ${f}
...
├ ${f}${prefix}sᴛᴀᴛᴜs${f}
├ ${f}${prefix}ᴛᴇʀᴍ${f}
├ ${f}${prefix}ʙʟᴏᴄᴋʟɪsᴛ${f}
├ ${f}${prefix}ʀᴜɴ${f}
├ ${f}${prefix}ᴄʜᴀᴛʟɪsᴛ${f}
├ ${f}${prefix}ᴏᴡɴᴇʀ${f}
├ ${f}${prefix}ᴊᴏɪɴ Linkgroup${f}
├ ${f}${prefix}ɢᴇᴛᴘɪᴄ @tag${f}
├ ${f}${prefix}ɢᴇᴛʙɪᴏ @tag${f}
├ ${f}${prefix}ᴘɪɴ${f}
├ ${f}${prefix}ɪɴғᴏ${f}
├ ${f}${prefix}ᴜɴᴘɪɴ${f}
├ ${f}${prefix}ᴀʀᴄʜɪᴠᴇ${f}
├ ${f}${prefix}ᴜɴᴀʀᴄʜɪᴠᴇᴀʟʟ${f}
├ ${f}${prefix}ʀᴇᴀᴅᴀʟʟ${f}
├ ${f}${prefix}ᴅᴇʟᴛʜɪsᴄʜᴀᴛ${f}
├ ${f}${prefix}sʜᴜᴛᴅᴏᴡɴ${f}
├ ${f}${prefix}ʜɪᴅᴇᴛᴀɢ Text${f}
├ ${f}${prefix}sᴛᴄᴛᴀɢ Tag Stc${f}
├ ${f}${prefix}ɪᴍɢᴛᴀɢ Tag Img${f}
├ ${f}${prefix}ᴋᴏɴᴛᴀɢ Text${f}
├ ${f}${prefix}ᴋᴏɴᴛᴀᴋ 6281xxx Nama${f}
├ ${f}${prefix}sᴇᴛᴛʜᴜᴍʙ${f}
├ ${f}${prefix}sᴇᴛʀᴇᴘʟʏ${f}
├ ${f}${prefix}sᴇᴛʙᴏᴅʏᴍᴇɴᴜ${f}
├ ${f}${prefix}sᴇᴛᴡᴇʟᴄᴏᴍᴇ${f}
├ ${f}${prefix}sᴇᴛʟᴇᴀᴠᴇ${f}
├ ${f}${prefix}sᴇᴛᴘʀᴏᴍᴏᴛᴇ${f}
├ ${f}${prefix}sᴇᴛᴅᴇᴍᴏᴛᴇ${f}
├ ${f}${prefix}ᴜᴘsᴡᴛᴇxᴛ${f}
├ ${f}${prefix}ᴜᴘsᴡɪᴍɢ${f}
├ ${f}${prefix}ᴜᴘsᴡᴠɪᴅᴇᴏ${f}
├ ${f}${prefix}ᴡᴇʟᴄᴏᴍᴇ 1/0${f}
├ ${f}${prefix}ʟɪɴᴋɢʀᴏᴜᴘ${f}
├ ${f}${prefix}ɢʀᴏᴜᴘ tutup/buka${f}
├ ${f}${prefix}ᴀᴅᴅ 6281xxx${f}
├ ${f}${prefix}ᴋɪᴄᴋ @tag${f}
├ ${f}${prefix}ᴘʀᴏᴍᴏᴛᴇ @tag${f}
├ ${f}${prefix}ᴅᴇᴍᴏᴛᴇ @tagadmin${f}
├ ${f}${prefix}ᴅᴇᴍᴏᴛᴇᴀʟʟ${f}
├ ${f}${prefix}ᴇᴅᴏᴛᴇɴsᴇɪ @tag${f}
├ ${f}${prefix}ʟɪsᴛᴀᴅᴍɪɴ${f}
├ ${f}${prefix}ᴏɴʟɪɴᴇ${f}
├ ${f}${prefix}ɪɴғᴏᴀʟʟ${f}
├ ${f}${prefix}ɴᴏᴛɪғ${f}
├ ${f}${prefix}ʟᴇᴀᴠᴇ${f}
├ ${f}${prefix}ᴀᴅᴅsᴛɪᴋ ᴏᴘᴛɪᴏɴᴀʟ${f}
├ ${f}${prefix}ᴀᴅɪᴍɢ ᴏᴘᴛɪᴏɴᴀʟ${f}
├ ${f}${prefix}ᴀᴅᴅᴠɪᴅ ᴏᴘᴛɪᴏɴᴀʟ${f}
├ ${f}${prefix}ᴀᴅᴅᴠɴ ᴏᴘᴛɪᴏɴᴀʟ${f}
├ ${f}${prefix}ɢᴇᴛsᴛɪᴋ ǫᴜᴇʀʏ${f}
├ ${f}${prefix}ɢᴇᴛɪᴍɢ ǫᴜᴇʀʏ${f}
├ ${f}${prefix}ɢᴇᴛᴠɪᴅ ǫᴜᴇʀʏ${f}
├ ${f}${prefix}ɢᴇᴛᴠɴ ǫᴜᴇʀʏ${f}
├ ${f}${prefix}ʟɪsᴛsᴛɪᴄᴋ${f}
├ ${f}${prefix}ʟɪsᴛɪᴍɢ${f}
├ ${f}${prefix}ʟɪsᴛᴠɪᴅ${f}
├ ${f}${prefix}ʟɪsᴛᴠɴ${f}
│
...
eka.sendMessage(from, menu, text,{contextInfo: {forwardingScore : 508, isForwarded: true},quoted : ftroli})
           ...
           eka.sendMessage(from, `${args.join(' ')}`, MessageType.text, {quoted :ftroli}) 
        	...
        	try {
          	ppimg = await eka.getProfilePicture(ghost)
          	} catch {
          	ppimg = 'https://i0.wp.com/www.gambarunik.id/wp-content/uploads/2019/06/Top-Gambar-Foto-Profil-Kosong-Lucu-Tergokil-.jpg'
          	}
const totalchat2 = await eka.chats.all()
            const conts2 = mek.key.fromMe ? eka.user.jid : eka.contacts[sender] || { notify: jid.replace(/@.+/, '') }
          	const ushname2 = mek.key.fromMe ? eka.user.name : conts.notify || conts.vname || conts.name || '-'
        	const bruhhhh2 = { contextInfo: {MentionedJid: ['6288221400832@s.whatsapp.net'],participant: itsme, quotedMessage: {extendedTextMessage: { text: split, }}}}
      		/*eka.on('CB:action,,battery', json => {
			const batteryLevelStrr = json[2][0][1].value
			const batterylevell = parseInt(batteryLevelStrr)
			reply('[EKASelf] your battery:'+ batterylevell +'%')
			reply('Your battery:'+ batterylevell +'%')*/
			const infonye = `*Super big thanks to ALLAH*
      
❏ From Purwodadi Grobogan ❏
...
├ lib : Baileys
├ version : 9.9.9
├ Ig : instagram.com/ekagans_02
├ Merk HP : Xiaomi redmi 9A
├ versi wa : ${eka.user.phone.wa_version}
├ Host : @6288221400832
├ Versi : Android 10
├ Karnel : 9999999
├ shell : 69.69.69
├ run = nodejs
├ CPU DEVICE : MT6797M (3)
├ Ram : ${(process.memoryUsage().heapUsed / 1024 / 1024).toFixed(2)}MB / ${Math.round(require('os').totalmem / 1024 / 1024)}MB`
└─────────────
anu  = {caption:`${infonye}`,thumbnail: fs.readFileSync('./eka.jpeg'),contextInfo: {

mentionedJid: ['6288221400832@s.whatsapp.net'],"forwardingScore":999,"isForwarded":true,'stanzaId': "B826873620DD5947E683E3ABE663F263", 'participant': `0@s.whatsapp.net`, 'remoteJid': 'status@broadcast', 'quotedMessage': {"imageMessage": {"caption": `「 _RunTime_ 」\n*${kyun(uptime)}*`, 'jpegThumbnail': fs.readFileSync('./eka.jpeg')}}}}
  			bufferh2 = await getBuffer(ppimg)
        	eka.sendMessage(from, bufferh2, image, anu)
           	break
            case 'unmute':
                if (!mek.key.fromMe) return reply('*Kamu Owner?*')
